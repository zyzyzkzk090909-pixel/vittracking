...
try:
    from timm.layers import PatchEmbed, Mlp, DropPath, get_norm_layer, get_act_layer
    from timm.layers import trunc_normal_
except:
    from timm.models.layers import PatchEmbed, Mlp, DropPath, get_norm_layer, get_act_layer
    from timm.models.layers import trunc_normal_

# ====== 兼容不同 timm 版本 ======
try:
    from timm.layers import AttentionPoolLatent, RmsNorm, PatchDropout, SwiGLUPacked
except:
    AttentionPoolLatent = None
    RmsNorm = None
    PatchDropout = None
    SwiGLUPacked = None
try:
...
@register_model
def vit_tiny_distilled_patch16_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    """ ViT-Tiny (Vit-Ti/16)
    """
